...
import 'package:plant_social_flutter/screens/comments_screen.dart';
import 'package:plant_social_flutter/utils/colors.dart';
import 'package:plant_social_flutter/utils/utils.dart';
import 'package:plant_social_flutter/widgets/like_animation.dart';
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              onDoubleTap: () async {
                await FiresStoreMethods().likePost(
                  widget.snap['postId'],
                  user.uid,
                  widget.snap['likes'],
                );
